      ...
      <div className="container mx-auto flex relative justify-center md:justify-end">
        {
          showLogin ? 
            <form action="" className="bg-white p-4 shad md:shadow-none flex flex-col rounded-md gap-4 w-full max-w-md">
              ...
              <div data-aos="fade-down" data-aos-delay="1000" className="flex items-center gap-1 border-b border-dark/20 text-dark/50 p-2">
                <IoKeyOutline />
            ...
            <form action="" className="bg-white p-4 shad md:shadow-none flex flex-col rounded-md gap-4 w-full max-w-md">
              ...
              <div data-aos="fade-up" data-aos-delay="1500" className="flex items-center gap-1 border-b border-dark/20 text-dark/50 p-2">
                ...
                <input type="text" value={inputs.firstname} name='firstname' onChange={handleChange} required placeholder='First Name e.g. Emily' className="flex-1 p-1 outline-none" />
              </div>
              <div data-aos="fade-up" data-aos-delay="1500" className="flex items-center gap-1 border-b border-dark/20 text-dark/50 p-2">
                <BsPersonSquare />
                <input type="text" value={inputs.lastname} name='lastname' onChange={handleChange} required placeholder='Last Name e.g. Duncan' className="flex-1 p-1 outline-none" />
              </div>
              <div data-aos="fade-up" data-aos-delay="1500" className="flex items-center gap-1 border-b border-dark/20 text-dark/50 p-2">
                <TbMailForward />
                <input type="email" value={inputs.email} name= 'email' onChange={handleChange} required placeholder='Emilyduncan@email.com' className="flex-1 p-1 outline-none" />
              </div>
              <div data-aos="fade-down" data-aos-delay="1000" className="flex items-center gap-1 border-b border-dark/20 text-dark/50 p-2">
                <RiLockPasswordLine />
